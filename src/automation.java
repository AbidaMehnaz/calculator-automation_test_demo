...
public class automation {
    public static void main(String[] args) throws MalformedURLException {
        ...
        el1.click();
        MobileElement el2 = (MobileElement) ad.findElementById("com.android.calculator2:id/digit_2");
        el2.click();
        ...
        el5.click();
        Assert.assertEquals(ad.findElementById("com.android.calculator2:id/result").getText(),"97");
